...
! Print the help message (invoked with the --help or -h command options) 
  ...
  subroutine print_help_message
    ...
    write(stderr,'(a)') '                         H    : pp/ppbar -> Higgs + jet (default)' 
    write(stderr,'(a)') '                         bbH  : b bbar -> Higgs + jet' 
    write(stderr,'(a)') '                         Z    : pp/ppbar -> Z + jet' 
    ...
    write(stderr,'(a)') '  --log                  Enables logarithmic x-axis of histogram, i.e. logarithmic bins in pT'
    ...
    write(stderr,'(a)') '  --accuracy <value>     The desired integration accuracy, default = 0.001'
    ...
    write(stderr,'(a)') '  --yt <value>           Top Yukawa factor, default = 1'
    write(stderr,'(a)') '  --yb <value>           Bottom Yukawa factor, default = 1 (0 for CP-odd Higgs)'
