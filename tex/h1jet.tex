...
\end{equation}
For $\textbf{M1}_{\textbf{5}}$ and $\textbf{M1}_{\textbf{14}}$ the mixing angle is $\theta_L = \theta_T$ where $\theta_T$ is set by the option \texttt{--sth2}, while for $\textbf{M4}_{\textbf{5}}$ and $\textbf{M4}_{\textbf{14}}$ the mixing angle is $\theta_R = \theta_T$ with 
\begin{equation}
...
\noindent All of the MSSM specific options are: 
\begin{description}[labelindent=\parindent, labelwidth =\widthof{\bfseries9999999999999999999999}, leftmargin = !] 
